...
function usdToRastr(_0xa){return Math.round(_0xa*100)/100;}
...
function renderSkinIcon(_0xs){if(_0xs.shortname){return '<div class="skin-icon"><img src="https://api.yrsproject.ru/public/image/Resize?shortname='+_0xs.shortname+'&x=128&y=128" alt="'+_0xs.name+'" loading="lazy" style="width:100%;height:100%;object-fit:contain"></div>';}var _0xk=_0xs.svg||'d';return '<div class="skin-icon">'+(_0xS_C[_0xk]||_0xS_C.d)+'</div>';}

// ===== RARITIES (Legendary=жовтий, Mythical=червоний) =====
const RARITIES={common:{name:'Обычный',color:'#4aa8ff'},rare:{name:'Редкий',color:'#a55cff'},legendary:{name:'Легендарный',color:'#f5c542'},mythical:{name:'МИФИЧЕСКИЙ',color:'#ff0044'}};

// ===== SKINS =====
const SKINS=[
// --- ЗБРОЯ ---
{id:'tempered_ak47',name:'Tempered AK47',shortname:'rifle.ak',svg:'r',rarity:'rare',price:11.47},
{id:'alien_red',name:'Alien Red',shortname:'rifle.ak',svg:'r',rarity:'mythical',price:172.00},
{id:'glory_ak47',name:'Glory AK47',shortname:'rifle.ak',svg:'r',rarity:'mythical',price:259.00},
{id:'after_death_ar',name:'After Death AR',shortname:'rifle.ak',svg:'r',rarity:'mythical',price:114.00},
...
// --- ПИСТОЛЕТЫ ---
{id:'revolver_basic',name:'Revolver',shortname:'pistol.revolver',svg:'p',rarity:'common',price:0.66},
...
// --- ДРОБОВИКИ ---
{id:'waterpipe_shotgun',name:'Waterpipe Shotgun',shortname:'shotgun.waterpipe',svg:'r',rarity:'common',price:1.14},
...
// --- ЛУКИ ---
{id:'bow_basic',name:'Hunting Bow',shortname:'bow.hunting',svg:'cr',rarity:'common',price:0.38},
{id:'crossbow_basic',name:'Crossbow',shortname:'crossbow',svg:'cr',rarity:'common',price:0.57},
{id:'compound_bow',name:'Compound Bow',shortname:'bow.compound',svg:'cr',rarity:'common',price:0.95},
...
// --- БЛИЖНИЙ БОЙ ---
{id:'bone_knife',name:'Bone Knife',shortname:'knife.bone',svg:'k',rarity:'common',price:0.19},
{id:'wooden_spear',name:'Wooden Spear',shortname:'spear.wooden',svg:'r',rarity:'common',price:0.24},
{id:'stone_spear',name:'Stone Spear',shortname:'spear.stone',svg:'r',rarity:'common',price:0.48},
{id:'stone_hatchet_basic',name:'Stone Hatchet',shortname:'stonehatchet',svg:'a',rarity:'common',price:0.29},
